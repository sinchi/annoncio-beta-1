...
SearchListController = RouteController.extend({
	...
	subscriptions: function(){
		this.annoncesSub =  Meteor.subscribe('searchAnnonces', this.findOption(), this.searchText(), this.params.city || '', this.params.category || '');
		this.photosSub =  Meteor.subscribe('photos');
	},
	annonces: function(){
		//console.log(this.findOption());
		return Annonces.find({title: this.searchText(), cityId: this.params.city, categoryId: this.params.category}, this.findOption());
	},
	data: function(){
